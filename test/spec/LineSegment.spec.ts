...
describe("intersectsLineSegment()", function () {
  test("returns intersection point if two line segments share an endpoint (no matter whether or not collinearity is considered).", function () {
  ...
  test("returns a point with NANs if two line segments overlap and collinear overlap is considered, and returns undefined if not considered.", function () {
  ...
  test("returns the intersectionpoint if two line intersects each other.", function () {
  ...
  test("returns a Point with NaNs if two line segments are collinear and collinearity is considered, and returns undefined if not considered.", function () {
    const a = new LineSegment(new Point(0, 0), new Point(2, 2));
...
describe("intersectsPolygon()", function () {
  test("returns the expected intersection points for a linesegment going through the polygon", function () {
  ...
  test("returns the expected intersection points for a linesegment which ends/starts on the polygon boundary", function () {
  ...
  test("returns the expected intersection points for a linesegment which ends/starts in the polygon", function () {
