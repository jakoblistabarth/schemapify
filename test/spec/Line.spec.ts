...
describe("getPointOnLine()", function () {
  test("returns a 2 point on a vertical line", function () {
  ...
  test("returns a 2 point on a horizontal line", function () {
  ...
  test("returns a 2 point on a 45deg line", function () {
...
describe("intersectsLine()", function () {
  test("returns a vertex if 2 lines intersect", function () {
  ...
  test("returns false for 2 parallel lines (no intersection point", function () {
    const a = new Line(new Point(0, 0), Math.PI * 0.5);
